import { Shield, Calculator, FileText, Users, Clock, Coins } from 'lucide-react';
...
export default function Services() {
  const services = [
    ...
    },
    {
      ...
      description: 'Comprehensive tax consulting services for businesses of all sizes.',
    },
    {
    ...
    },
    {
      ...
      description: 'Integrated financial planning with tax optimization strategies.',
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Comprehensive tax services tailored to meet your personal and business needs.
          </p>
        </div>
