...
export default function TaxIncorporationPage() {
  ...
  const processSteps = [
    {
      ...
      icon: <Users className="h-8 w-8 text-[#3c5473]" />,
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white font-sans">
      ...
      <main>
        {/* Hero Section */}
        <section className="relative overflow-hidden bg-gradient-to-r from-[#3c5473] via-[#8694ac] to-indigo-900 text-white">
              ...
              >
                <div className="space-y-6">
                  ...
                  <h1 className="text-4xl md:text-4xl lg:text-6xl font-bold leading-tight">
                    Strategic Tax <span className="text-blue-300">MINISTARY OF CORPORATE AFFAIRS </span> For Your Business
                  </h1>
                  ...
                  <div className="flex flex-wrap gap-4 pt-4">
                    ...
                    <Link
                      href="#process"
                      className="bg-transparent hover:bg-blue-700 text-blue-600 border border-white font-medium py-3 px-6 rounded-lg transition-all duration-300 inline-flex items-center"
                    >
                      Learn More
                    </Link>
                  </div>
